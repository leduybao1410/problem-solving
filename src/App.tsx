...
export default function App() {
  ...
  return (
    <div className="w-screen h-screen bg-gray-900 overflow-hidden flex items-center justify-center md:p-0 p-4">
      ...
      <div className="absolute md:w-1/2 w-4/5 md:top-0 md:right-0 md:h-full h-fit bg-gradient-to-br from-gray-800/90 via-gray-700/90 to-gray-900/90 flex flex-col items-stretch justify-center p-6 md:rounded-tl-3xl md:rounded-bl-3xl rounded-3xl shadow-lg text-white">
